...
export EXTENSION_DIR=/opt/cpanel/ea-php80/root/usr/lib64/php/modules
...
./configure \
    ...
    --prefix=/opt/cpanel/ea-php80/root/usr \
    --exec-prefix=/opt/cpanel/ea-php80/root/usr \
    --bindir=/opt/cpanel/ea-php80/root/usr/bin \
    --sbindir=/opt/cpanel/ea-php80/root/usr/sbin \
    --sysconfdir=/opt/cpanel/ea-php80/root/etc \
    --datadir=/opt/cpanel/ea-php80/root/usr/share \
    --includedir=/opt/cpanel/ea-php80/root/usr/include \
    --libdir=/opt/cpanel/ea-php80/root/usr/lib64 \
    --libexecdir=/opt/cpanel/ea-php80/root/usr/libexec \
    --localstatedir=/opt/cpanel/ea-php80/root/var \
    --sharedstatedir=/opt/cpanel/ea-php80/root/var/lib \
    --mandir=/opt/cpanel/ea-php80/root/usr/share/man \
    --infodir=/opt/cpanel/ea-php80/root/usr/share/info \
    --cache-file=../config.cache \
    --with-libdir=lib \
    --with-config-file-path=/opt/cpanel/ea-php80/root/etc \
    --with-config-file-scan-dir=/opt/cpanel/ea-php80/root/etc/php.d \
    --disable-debug \
    ...
    --enable-fpm \
    --with-fpm-systemd \
    --libdir=/opt/cpanel/ea-php80/root/usr/lib64/php \
    --with-mysqli=shared \
    --enable-pdo=shared \
