...
mkdir -p $DEB_INSTALL_ROOT/opt/cpanel/ea-php80

install -d $DEB_INSTALL_ROOT/usr/local/bin
ln -sf /opt/cpanel/ea-php80/root/usr/bin/php $DEB_INSTALL_ROOT/usr/local/bin/ea-php80
install -d $DEB_INSTALL_ROOT/usr/bin
ln -sf /opt/cpanel/ea-php80/root/usr/bin/php-cgi $DEB_INSTALL_ROOT/usr/bin/ea-php80
...
mv ${DEB_INSTALL_ROOT}opt/cpanel/ea-php80/root/etc/php-fpm.conf.default .
# tmpfiles.d
...
gzip debian/tmp/opt/cpanel/ea-php80/root/usr/share/man/man1/phar.1
gzip debian/tmp/opt/cpanel/ea-php80/root/usr/share/man/man1/phar.phar.1
gzip debian/tmp/opt/cpanel/ea-php80/root/usr/share/man/man1/php-cgi.1
gzip debian/tmp/opt/cpanel/ea-php80/root/usr/share/man/man1/php.1
gzip debian/tmp/opt/cpanel/ea-php80/root/usr/share/man/man1/phpize.1
gzip debian/tmp/opt/cpanel/ea-php80/root/usr/share/man/man1/phpdbg.1
gzip debian/tmp/opt/cpanel/ea-php80/root/usr/share/man/man1/phpconfig.1
gzip debian/tmp/opt/cpanel/ea-php80/root/usr/share/man/man1/php-config.1
gzip debian/tmp/opt/cpanel/ea-php80/root/usr/share/man/man8/php-fpm.8
...
mkdir -p ${DEB_INSTALL_ROOT}/opt/cpanel/ea-php80/root/var/log/php-fpm
mkdir -p ${DEB_INSTALL_ROOT}/opt/cpanel/ea-php80/root/etc/sysconfig/php-fpm
mkdir -p ${DEB_INSTALL_ROOT}/opt/cpanel/ea-php80/root/usr/share/php
